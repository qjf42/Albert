...
class Downloader:
    '''http请求工具类'''
    def __init__(self, timeout=1, retry=3, headers=None, **kwargs):
        self.timeout = timeout
        self.retry = retry
        self._session = requests.Session()
        self.headers = headers or {}

    def download(self, url: str, params: Dict = None, data: Dict = None,
        ...
        for atmpt in range(1, self.retry + 1):
            try:
                res = self._session.request(req_type.upper(), url, params=params, data=data,
